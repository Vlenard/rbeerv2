...
//const icons = [brown, dark, ipa, lager]; future use
    ...
    return (
        <div className="flex flex-col w-72 m-4 p-4 rounded-lg shadow-lg">
            ...
            <div className='flex justify-center mt-2'>
                ...
                <button onClick={deleteBeer} className='bg-[#fdebca] rounded-full p-3 ms-2 group hover:bg-red-500 cursor-pointer transition-colors'>
